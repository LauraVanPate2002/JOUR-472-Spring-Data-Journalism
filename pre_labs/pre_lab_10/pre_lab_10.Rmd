...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer: Something that I noticed is that each county that is highest rated in Maryland vs lowest rated is that the counties are spread out throughout the state of Maryland instead of just appearing in one general location and I found that interesting because I always thought that the Baltimore area would be the lowest rated because of the crime.**
