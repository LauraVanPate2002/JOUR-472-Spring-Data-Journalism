...
**A1: This read_csv has an https:// which means that it's a website.**
...
**A3:** The deepest is 645.729 with the magnitude being 4.20
...
**A4: 4 with a magnitude larger than six.**
...
**A5: There are three earthquakes with a depth of less than 20 and magnitude of six.**
...
**A7: Places should be the column. 2,651.**
...
**A8: 5. Two most common are earthquake and quarry blast.**
...
**A9: 21.7 for earthquake, .3 explosion, 0.0 ice quake, other event 6.3m quarry blast -1.1**
...
**A11: Last Column shows serious vs. not serious**
